...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TASKWAVE.ENTITY.Model.Acesso", b =>
                {
            ...
            modelBuilder.Entity("TASKWAVE.ENTITY.Model.Ambiente", b =>
                {
            ...
            modelBuilder.Entity("TASKWAVE.ENTITY.Model.Equipe", b =>
                {
            ...
            modelBuilder.Entity("TASKWAVE.ENTITY.Model.HistoricoTarefa", b =>
                {
            ...
            modelBuilder.Entity("TASKWAVE.ENTITY.Model.Mensagem", b =>
                {
            ...
            modelBuilder.Entity("TASKWAVE.ENTITY.Model.Projeto", b =>
                {
            ...
            modelBuilder.Entity("TASKWAVE.ENTITY.Model.Setor", b =>
                {
            ...
            modelBuilder.Entity("TASKWAVE.ENTITY.Model.Tarefa", b =>
                {
            ...
            modelBuilder.Entity("TASKWAVE.ENTITY.Model.Usuario", b =>
                {
            ...
            modelBuilder.Entity("TASKWAVE.ENTITY.Model.Equipe", b =>
                {
                    b.HasOne("TASKWAVE.ENTITY.Model.Setor", "Setor")
                        .WithMany("Equipes")
            ...
            modelBuilder.Entity("TASKWAVE.ENTITY.Model.HistoricoTarefa", b =>
                {
                    b.HasOne("TASKWAVE.ENTITY.Model.Tarefa", "Tarefa")
            ...
            modelBuilder.Entity("TASKWAVE.ENTITY.Model.Setor", b =>
                {
                    b.HasOne("TASKWAVE.ENTITY.Model.Ambiente", "Ambiente")
                        .WithMany("Setores")
            ...
            modelBuilder.Entity("TASKWAVE.ENTITY.Model.Tarefa", b =>
                {
                    b.HasOne("TASKWAVE.ENTITY.Model.Projeto", "Projeto")
                        .WithMany("Tarefas")
            ...
            modelBuilder.Entity("TB_ACESSO_USUARIO", b =>
                {
                    b.HasOne("TASKWAVE.ENTITY.Model.Acesso", null)
                        .WithMany()
                    ...
                    b.HasOne("TASKWAVE.ENTITY.Model.Usuario", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TB_EQUIPE_PROJETO", b =>
                {
                    b.HasOne("TASKWAVE.ENTITY.Model.Equipe", null)
                        .WithMany()
                    ...
                    b.HasOne("TASKWAVE.ENTITY.Model.Projeto", null)
                        .WithMany()
